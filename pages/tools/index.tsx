          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                {/* Grid */}
                <div className="grid sm:grid-cols-2 lg:grid-cols-2 lg:sidebar-expanded:grid-cols-2 xl:sidebar-expanded:grid-cols-4 gap-6">
                  {/* Item */}
                  <div className="bg-orange-100 rounded-sm text-center p-5">
